<?php
    ...
    $query = "SELECT accountNumber, email, phoneNumber FROM CUSTOMER";
    ...
    $inputAcct = "INSERT INTO CUSTOMER VALUES ('".$accountNumber."', '".$email."', '".$firstname."', '".$lastName."' , '".$password."', '".$fullAddress."', '".$phoneNumber."', '".$date."')";
